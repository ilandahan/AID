...
- Use `skills/role-data-scientist/references/rag-architecture-guide.md` → Decision Matrix
...
**Reference**: `skills/role-data-scientist/references/monitoring-setup-guide.md` for full signal catalog
...
**Reference**: `skills/role-data-scientist/references/ml-pipeline-checklist.md` → Phase 4 section  
**Reference**: `skills/role-data-scientist/references/rag-architecture-guide.md` (if RAG system)
