...
**Reference**: `skills/role-data-scientist/references/monitoring-setup-guide.md` for full configuration template
...
- [ ] Bias audit completed per `skills/role-data-scientist/references/bias-audit-checklist.md`
...
- [ ] Model card completed per `skills/role-data-scientist/references/model-card-template.md`
...
**Reference**: `skills/role-data-scientist/references/monitoring-setup-guide.md`  
**Reference**: `skills/role-data-scientist/references/model-card-template.md`  
**Reference**: `skills/role-data-scientist/references/bias-audit-checklist.md`
