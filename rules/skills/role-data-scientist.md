...
- `rules/skills/phase-1-eda.md`
- `rules/skills/phase-2-feasibility.md`
- `rules/skills/phase-3-experiment-planning.md`
- `rules/skills/phase-4-ml-architecture.md`
- `rules/skills/phase-5-development.md`
- `rules/skills/phase-6-production.md`
