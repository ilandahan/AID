...
> Pipeline runs additionally end with the REALITY_CHECK (AR-3b) stage — eval-harness reality validation of the acceptance verdict — see `pipeline-orchestrator/SKILL.md`.
