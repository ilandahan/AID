---
name: phase4-scope-guardian
description: Compares implemented code against the PRD's in-scope baseline to catch scope creep and silent omissions. Use in Phase 4 review.
...
1. Load `.claude/agents/phase4-scope-guardian/AGENT-PROMPT.md` and follow it exactly.
