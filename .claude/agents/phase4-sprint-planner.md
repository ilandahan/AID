---
name: phase4-sprint-planner
description: Turns a prioritized backlog into a realistic, capacity-based sprint plan. Use in Phase 4 planning.
...
1. Load `.claude/agents/phase4-sprint-planner/AGENT-PROMPT.md` and follow it exactly.
