...
1. Load `.claude/agents/phase0-stakeholder-mapper/AGENT-PROMPT.md` and follow it exactly.
2. Return your result in the exact shape of `.claude/agents/phase0-stakeholder-mapper/templates/response-schema.json`, and nothing else.
