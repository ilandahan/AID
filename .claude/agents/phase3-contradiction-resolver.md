---
name: phase3-contradiction-resolver
description: Finds and resolves contradictions between the PRD and the technical specification. Use in Phase 3a consolidation.
...
1. Load `.claude/agents/phase3-contradiction-resolver/AGENT-PROMPT.md` and follow it exactly.
