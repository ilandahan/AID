...
| `data-scientist` | Data Scientist | DS | Data pipelines, ML models, RAG/CAG, prompt engineering, analytics, observability, governance, responsible AI |
...
| Phase | Name | Description | Skills |
|-------|------|-------------|--------|
| 0 | EDA — Data Gathering & Analysis | Gather data sources, perform exploratory data analysis, assess data quality, create clean datasets | pre-prd-research, aid-discovery |
| 1 | Feasibility Assessment | Assess ML feasibility, evaluate baselines vs. heuristics, identify biases, define success metrics and constraints | aid-prd |
| 2 | Experiment Planning | Plan experiments with hypotheses, define evaluation criteria, design A/B tests, select model candidates | aid-impl-plan |
| 3 | ML Architecture & Pipeline Design & Task Breakdown | Design ML architecture, data pipelines, RAG/CAG systems, feature engineering strategy, break down into tasks | aid-tech-spec, system-architect |
| 4 | Development & Validation | Implement pipelines, train models, engineer prompts, run experiments, validate against thresholds, bias audit | aid-development, test-driven |
| 5 | Deploy to Production & Monitoring | Deploy models, configure monitoring and alerting, finalize model cards, set up drift detection, rollback procedures | aid-qa-ship, test-driven |
...
See `references/role-phase-terminology.json` for the machine-readable version.
