...
Cucumber BDD is automatically installed for executable acceptance criteria:

```bash
# Check Cucumber is installed
npx cucumber-js --version

# Validate feature files (if any exist)
...
| `features/support/` | World, hooks, helpers |
| `reports/` | HTML/JSON test reports |

See `.claude/skills/cucumber-bdd/` for full Cucumber documentation.
