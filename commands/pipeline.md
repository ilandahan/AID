---
description: "Start or resume the automated development pipeline for the current task"
---
...
Load the pipeline-orchestrator skill from `skills/pipeline-orchestrator/SKILL.md`.
