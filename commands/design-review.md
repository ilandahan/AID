---
description: "Review a Figma component design before code extraction"
---
...
3. Load the `figma-design-review` skill from `skills/`
...
Load: `skills/figma-design-review/SKILL.md`
