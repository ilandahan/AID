---
name: phase2-requirements-tracer
description: Verifies every business requirement maps to something in the technical specification, and produces a coverage matrix. Use in Phase 2 review.
