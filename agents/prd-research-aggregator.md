---
name: prd-research-aggregator
description: Reads all Phase 0 research and produces a structured Research Brief a PRD writer can work from. Use at the start of Phase 1.
